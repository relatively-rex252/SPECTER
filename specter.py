...
def open_app(app_name):
    ...
    if app_name_lower in APP_MAP:
        ...
        try:
            ...
            speak(f"I don't know how to open {app_name}. You can add it to my app list in the config.")
...
def listen_for_wake_word():
    """Continuously listen for 'Hey Rex'."""
    ...
    wake_variations = ["specter", "specter", "spector", "spectre", "spec", "specter please"]
    ...
    while True:
        try:
            ...
            try:
                ...
                print(f"[SPECTER] Heard: '{text}'")  # Shows everything it hears
...
if __name__ == "__main__":
    print("=" * 45)
    print("  SPECTER - Responsive Execution eXpert")
    print("  Say 'Specter' to wake me up!")
    print("=" * 45)
    speak("Specter online. Say Specter to wake me up.")
